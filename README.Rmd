...
# minimalTemplate
[![Build Status](https://travis-ci.com/kguidonimartins/minimalTemplate.svg?branch=master)](https://travis-ci.com/kguidonimartins/minimalTemplate)
...
fs::dir_tree(path = tmp_proj, recurse = TRUE)
```

You can edit the various README files distributed among the subdirectories to explain what these folders contain.
